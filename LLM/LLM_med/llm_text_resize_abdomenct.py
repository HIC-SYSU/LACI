...
train_data_path = '/data/xingshihanxiao/Pyproject/Data/open_data/AbdomenCT/'
db_train = LVHeart(base_dir=train_data_path,
                           split='train',
                           train_flod='all_data.txt',  # todo change training flod
...
text_path = '/data/chenjinfeng/code/semi_supervised/All_code/code_all/Flods/AbdomenCT/AbdomenCT_text.txt'
...
question = "Describe this abdominal CT image, including the major abdominal organs, their locations, shapes, and surrounding anatomical structures."
...
with open(text_path, 'w', encoding='utf-8') as f:
    for i_batch, sampled_batch in enumerate(tqdm(db_train)):
        ...
        # print("resized_feature:", resized_feature.shape)
        generation = llm_model.generate(resized_feature.to(dtype=torch.float16), input_id, seg_enable=False,  do_sample=False, max_new_tokens=256, top_p=0.9, temperature=1.0)   ##seg_enable=True,  do_sample=True,
        # , seg_logit
