...
from networks.vnet_DAE import VNetDAE, VNet
...
parser.add_argument('--exp', type=str,  default='AU_flod0/MT', help='model_name')
# parser.add_argument('--nb_labels', type=int,  default=16, help='trained samples')
# parser.add_argument('--model_DAE', type=str,  default='/data/chenjinfeng/code/semi_supervised/All_code/pre_weights/LA/AU_flod0/16/best_model_5736.pth', help='DAE model path')
...
parser.add_argument('--model_DAE', type=str,  default='/data/chenjinfeng/code/semi_supervised/All_code/code_all/weights/LA/AU_flod0/8/iter_6000.pth', help='DAE model path')

parser.add_argument('--patch_size', type=list, default=[112,112,80],help='patch size')
# parser.add_argument('--model_DAE', type=str,  default='/data/chenjinfeng/code/semi_supervised/All_code/pre_weights/LA/AU_flod0/4/best_model_1520.pth', help='DAE model path')

parser.add_argument('--num_classes', type=int,  default='2', help='num_classes')
parser.add_argument('--total_labels', type=int,  default=80, help='maximum samples to train')
...
snapshot_path =  "/data/chenjinfeng/code/semi_supervised/All_code/code_all/weights/{}/{}/{}".format(args.dataset, args.exp, args.nb_labels)
snapshot_path_DAE = args.model_DAE
...
if __name__ == "__main__":
    ...
    if args.dataset == "LA":
        db_train = LAHeart(base_dir=train_data_path,
                           ...
                           common_transform=transforms.Compose([
                               ...
                               ToTensor()]))
    #     db_val = LAHeart_all(base_dir=train_data_path,
    #                          split='train',
    #                          train_flod='test0.list',  # todo change training flod
    #                          common_transform=transforms.Compose([
    #                              RandomCrop(patch_size),
    #                          ]),
    ...
    #                              ToTensor(),
    #                          ]))
    # elif args.dataset == "AbdomenFLARE":
