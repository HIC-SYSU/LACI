...
parser.add_argument('--exp', type=str,  default="UPRC_flod0", help='model_name')
...
elif FLAGS.dataset == "Pancreas":
    with open('/data/chenjinfeng/code/semi_supervised/All_code/dataset/Pancreas/Flods/text0.txt', 'r') as f:
        image_list = f.readlines()
