...
parser.add_argument('--exp', type=str,  default='AU', help='model_name')
...
parser.add_argument('--max_iterations', type=int,  default=6000, help='maximum epoch number to train')      ## 论文中说是6k？
