...
parser.add_argument('--exp', type=str,  default="LeFed_flod0", help='model_name')
...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            for num in range(3):
                if num == 0:
                    outputs1, outputs2, masks, stage_out1, _ = model(volume_batch, [])      ## output是分割结果，masks是dncoder的每一层特征， stage_out是mask深度监督的结果
                else:
                ...
                for idx in range(len(masks[0])):
                    ...
                    en.append(1e-3*(mask1-mask2))    # 1e-3     ###两个decoder的特征差
