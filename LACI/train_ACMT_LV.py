...
parser.add_argument('--exp', type=str,  default="ACMT", help='model_name')
...
parser.add_argument('--total_sample', type=int,  default=369, help='maximum samples to train')
##
parser.add_argument('--model', type=str, default='vnet_ACMT', help='model_name')
parser.add_argument('--max_iterations', type=int, default=15000, help='maximum epoch number to train')       ##6k
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            try:
                ...
                mask_1 = (confident_maps == 1).float()
                mask_2 = (confident_maps == 2).float()
                mask = mask_1 + mask_2
