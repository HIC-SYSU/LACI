...
parser.add_argument('--nb_labels', type=int,  default=32, help='trained samples')
parser.add_argument('--trainlist', type=str,  default="train.txt", help='model_name')
parser.add_argument('--model_DAE', type=str,  default='/data/chenjinfeng/code/semi_supervised/All_code/code_all/weights/LV/AU/16/iter_6000.pth', help='DAE model path')
